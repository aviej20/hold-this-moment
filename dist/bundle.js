...
.grid-wrapper .footer-container > *, .grid-wrapper .footer-container a {
  font-weight: 400;
  color: white;
  text-align: center;
}
.grid-wrapper .footer-container a:hover {
  color: #70ca70;
}
...
@media only screen and (max-width: 600px) {
  .grid-wrapper {
    column-gap: 0;
    grid-template-rows: 0.33fr 2fr 0.25fr;
  }
  .grid-wrapper .hamburger.active {
    grid-column: 1/4;
  }
  ...
  .grid-wrapper .main-container .main-container__form #chat-form #user-input {
    width: 100%;
    height: 100%;
  }
  .grid-wrapper .main-container .chat-wrapper {
